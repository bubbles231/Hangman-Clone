...
def buttons_dict_maker(gm):
    buttons_dict = {}
    buttons_dict['start 1 player'] = ResourceLoader().make_button(gm,
                                                      (251, 251, 255),
                                                      0,
                                                      0,
                                                      300, 50, 0, 'Start 1 '
                                                      'Player', (10, 10, 10))
    buttons_dict['settings'] = ResourceLoader().make_button(gm,
                                                      (251, 251, 255),
                                                      100,
                                                      150,
                                                      200, 50, 0, 'Settings',
                                                      (10, 10, 10))
    buttons_dict['quit'] = ResourceLoader().make_button(gm,
                                                      (251, 251, 255),
                                                      200,
                                                      250,
                                                      100, 50, 0, 'Quit!',
